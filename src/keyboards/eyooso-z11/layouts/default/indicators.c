...
// Single-colour variant of the per-key animation engine: each LED has one
// brightness channel instead of R/G/B, so effects are moving brightness waves
// rather than hues.
...
// The effect maths live in src/smk/led_effect.{h,c}; the geometry tables are
// generated by utils/led_geometry_gen.c. This file only declares the matrix size
