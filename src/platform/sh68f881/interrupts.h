...
void uart_interrupt_handler(void) __interrupt(_INT_EUART);
#    define UNUSED_INTERRUPTS_EUART(X)
#else
#    define UNUSED_INTERRUPTS_EUART(X) X(euart, _INT_EUART, IEN0, _ES)
#endif
