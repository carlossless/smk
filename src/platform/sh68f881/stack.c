...
#    define STACK_TOP  0xFF // top of the SH68F881's 256-byte internal RAM

// paint the unused stack (above SP, up to STACK_TOP); run early in main(), while SP is shallow, for the widest window.
