...
#define LAYOUT_60( \
    ...
    K00_4, K01_4, K02_4,                      K05_4,                      K09_4, K10_4, K13_4, K14_4 \
) { \
    ...
    { K00_4, K01_4, K02_4, KC_NO, KC_NO, K05_4, KC_NO, KC_NO, KC_NO, KC_NO, K09_4, K10_4, KC_NO, K13_4, K14_4, KC_NO } \
}
...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT_60(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                           KC_SPC,                             KC_LGUI, KC_NO,   KC_DOWN, KC_RIGHT
    ),
};
