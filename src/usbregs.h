...
#define SET_EP1_CNT(COUNT) \
    do { CLEAR_EP1_CNT; IEP1CNT |= COUNT; } while (0)

#define CLEAR_EP2_CNT \
    do { IEP2CNT &= ~0x7f; } while(0)
#define SET_EP2_CNT(COUNT) \
    do { CLEAR_EP2_CNT; IEP2CNT |= COUNT; } while (0)
